...
test_printing_signal_name_from_exit_status "$LINENO" 1 HUP
test_printing_signal_name_from_exit_status "$LINENO" 2 INT
test_printing_signal_name_from_exit_status "$LINENO" 3 QUIT
test_printing_signal_name_from_exit_status "$LINENO" 6 ABRT
test_printing_signal_name_from_exit_status "$LINENO" 9 KILL
test_printing_signal_name_from_exit_status "$LINENO" 14 ALRM
test_printing_signal_name_from_exit_status "$LINENO" 15 TERM
